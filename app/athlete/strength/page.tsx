...
import { Play, Check, Dumbbell, TrendingUp, Calendar, Target, Activity } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      <aside className="fixed left-0 top-0 h-full w-64 bg-slate-900/50 backdrop-blur-xl border-r border-slate-800 p-6">
        <div className="flex items-center gap-3 mb-8">
          ...
          <div>
            <h1 className="text-lg font-bold text-white">Fortalecimento</h1>
            <p className="text-xs text-slate-400">Meu Treino</p>
          </div>
        </div>
