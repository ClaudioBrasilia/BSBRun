...
export function TrainingPlanView({ athlete, backHref, backLabel, title }: TrainingPlanViewProps) {
  if (!athlete.vdot) {
    return (
      <>
  ...
  return (
    <>
      <div className="mb-8">
        ...
        <p className="text-slate-400 mt-1">Periodização em 4 fases, gerada a partir do VDOT e do objetivo.</p>
      </div>
